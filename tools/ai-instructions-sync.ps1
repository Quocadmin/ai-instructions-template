...
class AIInstructionsSync {
    ...
    AIInstructionsSync() {
        ...
        $this.BackupDir = Join-Path $this.ProjectRoot "ai-agents-works\automation\backups"
        $this.LogFile = Join-Path $this.ProjectRoot "ai-agents-works\automation\ai-instructions-sync.log"
        $this.MetricsFile = Join-Path $this.ProjectRoot "ai-agents-works\metrics\sync-metrics.json"
